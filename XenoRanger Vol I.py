...
def main():
    ...
    main.rooms = {
        ...
        'Cafeteria': {'South': 'Library', 'West': 'Kitchen',
                      'part': 'Screen',
                      'information': '- No good smells in here. -',
        ...
        'Library': {'North': 'Cafeteria', 'South': 'Atrium', 'East': 'Fitness Center',
                    'part': 'Computer Chip',
                    'information': '- Shhh, people might be studying in here. -',
    ...
    while alien == 'Hidden':
        ...
        elif player_command in main.commands['Exit']:  # Branch to end game.
...
def intro():
    ...
    time.sleep(2)
    print('After being debriefed, you have an idea of how to handle the situation.')
    time.sleep(2)
    print('But you\'re not sure Main Ops will like it...\n')
    time.sleep(2)
...
def instructions():
    ...
    time.sleep(1)
    print('Avoid the Alien until you\'ve collected all 6 parts to build the Laser Vertoratio to win!')
    time.sleep(1)
    main()
...
def move_rooms():
    ...
    # Branch to end game.
    elif player_move in main.commands['Exit']:
        print('Thanks for playing!')
        quit()
...
def get_parts():
    ...
    if part == '':  # Branch if no parts to be found in the room.
        print('...')
        time.sleep(1)
        print('... Searching ...')
        time.sleep(1)
        ...
        if part not in inventory:  # Branch for new parts.
            print('...')
            time.sleep(1)
            print('... Searching ...')
            time.sleep(1)
            ...
            if len(inventory) == 6:  # Branch for building the Laser.
                print()
...
def winning_ending():
    ...
    if current_room == 'Kitchen':
        ...
        time.sleep(3)
        print('The sound that comes out of the device is like a garbled whale noise that startles the alien. \n')
        time.sleep(3)
